...
document.addEventListener("DOMContentLoaded", () => {
  const moreInformationTitle = document.querySelector(
  ...
  function displayInformation(data, cartaValue) {
    ...
    try {
      ...
      if (cartaValue === 1) {
        ...
        moreInformationParrafo.innerHTML = parrafo;
      }
      ...
      document.write(
        `se ha producido un error de cargar de multimedia ${err} porfarvor reincie la pagina`,
      );
    }
  }
});
